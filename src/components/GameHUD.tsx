  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-end w-full gap-2 sm:gap-4">
        {/* Left Side: Steering Paddles + Hydraulic Handbrake */}
        {showTouchControls ? (
        ...
        <div className="pointer-events-auto bg-zinc-950/90 border border-zinc-800/90 p-1.5 rounded-2xl backdrop-blur-md shadow-2xl flex items-center gap-1.5 mb-1">
        ...
        {showTouchControls && (
          <div className="pointer-events-auto flex items-end gap-2 sm:gap-3 pb-1">
            {/* Tactical Base Missile Launch Switch */}
            <button
              onClick={handleTriggerMissile}
              disabled={!isMissileReady}
              className={`relative w-14 h-16 sm:w-16 sm:h-18 rounded-2xl border-2 flex flex-col items-center justify-center transition-all shadow-xl active:scale-95 touch-none select-none ${
                isMissileReady
            ...
            >
              ...
              <span className="text-[9px] font-black leading-tight mt-1 text-center">
            ...
            <button
              ...
              className="w-14 h-16 sm:w-16 sm:h-18 rounded-2xl bg-gradient-to-b from-cyan-600 to-blue-900 active:from-cyan-400 active:to-blue-700 border-2 border-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.4)] flex flex-col items-center justify-center text-white active:scale-95 touch-none select-none"
            >
              <Zap className="w-6 h-6 sm:w-7 sm:h-7" />
              <span className="text-[9px] font-black uppercase font-mono mt-0.5">NOS</span>
            </button>

            {/* REALISTIC CAR BRAKE & REVERSE PEDAL (دواسة الفرامل والرجوع) */}
            <button
            ...
            >
              ...
              {/* Heavy Cross-Hatched Rubber Grip Slots */}
              <div className="w-full flex flex-col items-center gap-1 my-1">
                <div className="w-10 h-1 bg-red-400/80 rounded-full" />
                <div className="w-10 h-1 bg-red-400/80 rounded-full" />
                <div className="w-10 h-1 bg-red-400/80 rounded-full" />
                <div className="w-10 h-1 bg-red-400/80 rounded-full" />
              </div>
              ...
              {/* Label */}
              <span className="text-[10px] font-black uppercase tracking-wider text-red-100 font-mono">
                {t(lang, 'reverse')}
              </span>
            </button>

            {/* REALISTIC CAR SPORT GAS PEDAL (دواسة البنزين الرياضية) */}
            <button
            ...
            >
              {/* Chrome Pedal Mounting Bolts */}
              <div className="w-full flex justify-between px-1">
                <span className="w-2.5 h-2.5 rounded-full bg-zinc-300 border border-zinc-600 shadow-inner" />
                <span className="w-2.5 h-2.5 rounded-full bg-zinc-300 border border-zinc-600 shadow-inner" />
              </div>

              {/* Ribbed Metallic Grip Slots */}
              <div className="w-full flex flex-col items-center gap-1.5 my-1">
                <div className="w-12 h-1.5 bg-emerald-200/90 rounded-full shadow" />
                <div className="w-12 h-1.5 bg-emerald-200/90 rounded-full shadow" />
                <div className="w-12 h-1.5 bg-emerald-200/90 rounded-full shadow" />
                <div className="w-12 h-1.5 bg-emerald-200/90 rounded-full shadow" />
                <div className="w-12 h-1.5 bg-emerald-200/90 rounded-full shadow" />
              ...
              {/* Pedal Label */}
              <span className="text-xs font-black uppercase tracking-wider text-emerald-100 font-mono">
                {t(lang, 'gasPedal')}
              </span>
            </button>

            {/* FIGHTER-COCKPIT TURRET TRIGGER (زناد السلاح) */}
            <button
            ...
            >
              ...
              <div className="flex flex-col items-center my-auto">
                <Crosshair className="w-9 h-9 sm:w-10 sm:h-10 stroke-[2.5] text-zinc-900 animate-pulse" />
              </div>

              <span className="text-[10px] font-black uppercase tracking-wider text-zinc-950 font-mono">
                {t(lang, 'fireWeapon')}
              </span>
            </button>
          </div>
